...
function Review() {
  return (
    <div
      className=" w-full bg-white flex flex-col justify-center relative z-[-2] gap-10
    items-center"
    >
      <div className=" absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black via-transparent to-transparent z-[-1]"></div>
      <div class="nine">
